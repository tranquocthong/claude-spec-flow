...
module.exports = {
  ...
  doctor(args) {
    ...
    // whenever a second tag merely existed even with currentTag already correct.
    {
      ...
      if (activeFeat && fs.existsSync(tmDir)) {
